...
Generated: `2026-06-19T17:39:21+00:00`
...
| Metric | Count |
| --- | ---: |
| `source_local_hold` | 588 |
| `candidate_after_target_role` | 237 |
| `default_hold` | 351 |
...
| `source_proof_tests` | 78 | `pair_with_promoted_runtime_or_contract` |
| `source_runtime_or_capability` | 92 | `candidate_after_target_role` |
