...
Current Slice 01 promotion status: FA Local GNAT dispatch runtime/schema and
NeuronForge COR GNAT semantic handoff receipt runtime have been promoted into
app support as bounded surfaces. Cortex GNAT and DF Local read-only analytics
currently have support target-role or read-runtime receipts only. Unnamed
runtime, route, schema, migration, model execution, and durable behavior remain
